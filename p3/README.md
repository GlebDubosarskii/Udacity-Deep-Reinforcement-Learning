...
1. Install Anaconda https://www.anaconda.com/products/individual (Python 3.6).

2. Open a command prompt or Anaconda Prompt and navigate to the future environment folder (this could be any folder on your computer).
...
To run the code click on the file Tennis.ipynb. The file agent_model.py contains the neural network architecture. 
